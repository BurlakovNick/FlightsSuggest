...
using ConfigurationProvider = FlightsSuggest.Core.Configuration.ConfigurationProvider;

namespace FlightsSuggest.Admin
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IFlightsFunctions, FlightsFunctions>();
